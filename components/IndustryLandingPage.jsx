  ...
  return (
    <main className="bg-[#fcfdff] text-[#0b1d3a] dark:bg-[#071126] dark:text-white">
      ...
      <section className="mx-auto grid max-w-[1360px] gap-4 px-6 pb-8 md:px-10">
        <div className="rounded-xl border border-slate-200 bg-white p-5"><h2 className="text-center text-[10px] font-bold uppercase text-[#0c327e]">Technology Stack</h2><TechStackMarquee technologies={technologies} /></div>
