...
export default function Footer() {
  ...
  if (["/industries/agriculture", "/industries/energy-utilities"].includes(pathname)) {
    return <footer className="border-t border-slate-100 bg-white px-6 py-8 text-[#17333b] md:px-10"><div className="mx-auto grid max-w-[1360px] gap-7 text-[9px] leading-5 sm:grid-cols-2 lg:grid-cols-6"><div className="lg:col-span-2"><Link href="/" className="text-lg font-black tracking-[.14em] text-[#087c58]">ANTELLAY</Link><p className="mt-3 max-w-52 text-slate-500">Building intelligent solutions that power a sustainable and smarter tomorrow.</p></div><div><b>Services</b><p className="mt-2 text-slate-500">AI Strategy Consulting<br/>GIS & Mapping Solutions<br/>IoT Development<br/>Data Analytics</p></div><div><b>Industries</b><p className="mt-2 text-slate-500">Agriculture<br/>Energy & Utilities<br/>Smart Cities<br/>Infrastructure</p></div><div><b>Resources</b><p className="mt-2 text-slate-500">Case Studies<br/>Blogs<br/>Whitepapers<br/>Webinars</p></div><div><b>Contact Us</b><p className="mt-2 text-slate-500">+91 6377 541 331<br/>info@antellay.com<br/>Jaipur, Rajasthan</p></div></div><div className="mx-auto mt-7 flex max-w-[1360px] justify-between border-t border-slate-100 pt-4 text-[8px] text-slate-400"><span>© 2024 Antellay. All rights reserved.</span><span>Privacy Policy &nbsp; | &nbsp; Terms of Service &nbsp; | &nbsp; Sitemap</span></div></footer>;
  }

  if (["/services/data-annotation", "/industries/real-estate"].includes(pathname)) {
    return (
      <footer className="bg-[#031838] px-6 pb-6 pt-10 text-white md:px-10 lg:px-14">
        <div className="mx-auto grid max-w-[1360px] gap-8 text-[10px] leading-5 sm:grid-cols-2 lg:grid-cols-[1.45fr_repeat(4,1fr)]">
          <div>
            <Link href="/" className="inline-block text-xl font-black tracking-[.15em]">ANTELLAY</Link>
            <p className="mt-4 max-w-48 text-white/70">AI, GIS & Engineering solutions for enterprises and governments.</p>
            <div className="mt-5 flex gap-3 text-white/60"><SocialIcon type="linkedin"/><SocialIcon type="twitter"/><SocialIcon type="youtube"/><SocialIcon type="instagram"/></div>
          </div>
          <div><h3 className="mb-3 text-xs font-bold">Services</h3><p className="text-white/65">Artificial Intelligence<br/>GIS & Geospatial Services<br/>Data Annotation<br/>Cloud & Infrastructure<br/>Blockchain<br/>Cybersecurity</p></div>
          <div><h3 className="mb-3 text-xs font-bold">Industries</h3><p className="text-white/65">Government<br/>Smart Cities<br/>Construction<br/>Utilities<br/>Agriculture<br/>Healthcare<br/>More Industries</p></div>
          <div><h3 className="mb-3 text-xs font-bold">Resources</h3><p className="text-white/65">Case Studies<br/>Blog<br/>Whitepapers<br/>Documentation<br/>Webinars</p></div>
          <div><h3 className="mb-3 text-xs font-bold">Contact Us</h3><p className="text-white/65">+91 6377 541 331<br/>info@antellay.com<br/>Jaipur, Rajasthan, India</p></div>
        </div>
        <div className="mx-auto mt-8 flex max-w-[1360px] flex-col justify-between gap-3 border-t border-white/10 pt-5 text-[9px] text-white/50 sm:flex-row"><p>© 2024 ANTELLAY. All rights reserved.</p><p>Privacy Policy &nbsp;&nbsp; | &nbsp;&nbsp; Terms of Service &nbsp;&nbsp; | &nbsp;&nbsp; Sitemap</p></div>
      </footer>
    );
  }
