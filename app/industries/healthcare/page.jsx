...
const config = {
  ...
  solutions: [
    [ScanLine, "Medical Imaging AI", "/images/ai_data_hero.jpg", ["MRI Analysis", "CT Scan Analysis", "X-Ray Detection", "Ultrasound AI", "Mammography"]],
    [BrainCircuit, "Radiology AI", "/images/ai_data_cta.jpg", ["Tumor Detection", "Fracture Detection", "Lung Disease AI", "Stroke Detection", "AI Report Generation"]],
    [Activity, "Diagnostics AI", "/images/data-annotation-workspace.png", ["Pathology AI", "Blood Report Analysis", "Disease Prediction", "Early Detection", "Clinical Insights"]],
    [Building2, "Hospital AI", "/images/cloud_infra_hero.jpg", ["Patient Dashboard", "Bed Management", "Appointment AI", "Operation Scheduling", "Hospital Analytics"]]
  ],
  useCases: [["Hospitals", "/images/industries/Professional Services.jpg"], ["Diagnostic Centers", "/images/consulting_hero.jpg"], ["Radiology Labs", "/images/consumer-technology/capabilities.png"], ["Medical Colleges", "/images/industries/Education.jpg"], ["Telemedicine", "/images/consumer-technology/mobile-apps.png"], ["Cancer Centers", "/images/industries/Non-profit.jpg"], ["Government Hospitals", "/images/industry-showcases/government-smart-cities.png"], ["Research Institutes", "/images/industries/Technology.jpg"], ["Emergency Care", "/images/logistics/logistics-hero.png"]],
