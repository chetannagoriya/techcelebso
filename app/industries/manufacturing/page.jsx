...
const config = {
  ...
  solutions: [[ScanLine, "Quality Inspection AI", "/images/manufacturing/quality-inspection-v2.png", ["Defect Detection", "Surface Inspection", "Dimension Measurement", "Assembly Verification", "AI Vision Models"]], [Wrench, "Predictive Maintenance AI", "/images/energy-utilities/asset-monitoring.png", ["Failure Prediction", "RUL Estimation", "Anomaly Detection", "Vibration Analysis", "Maintenance Alerts"]], [Factory, "Industrial Automation", "/images/industries/Manufacturing.jpg", ["Process Automation", "Robotic Integration", "PLC/SCADA Integration", "Workflow Automation", "Edge AI Deployment"]], [BarChart3, "Production Analytics", "/images/manufacturing/production-analytics-v2.png", ["OEE Monitoring", "Cycle Time Analysis", "Yield Optimization", "Energy Analytics", "Bottleneck Detection"]]],
