...
const config = {
  ...
  solutions: [[PackageSearch, "Product AI", "/images/retail-ecommerce/retail-hero.png", ["Product Recognition", "Attribute Extraction", "Image Classification", "Smart Tagging", "Catalog Enrichment"]], [Warehouse, "Inventory Intelligence", "/images/logistics/warehouse-ai.png", ["Real-time Stock Tracking", "Stock Prediction", "Reorder Automation", "Warehouse Analytics", "Multi-location Sync"]], [BrainCircuit, "Recommendation Systems", "/images/consumer-technology/saas-platforms.png", ["Personalized Recommendations", "Customer Behavior", "Cross-sell & Upsell", "Dynamic Offers", "Real-time Personalization"]], [Camera, "In-Store Monitoring", "/images/retail-ecommerce/in-store-monitoring-v2.png", ["People Counting", "Queue Management", "Shelf Monitoring", "Heatmap Analytics", "Loss Prevention"]]],
