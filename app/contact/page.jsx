  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#F7F9FC] text-[#0B132B] transition-colors duration-300 dark:bg-[#081126] dark:text-white">
      <section className="relative border-b border-[#DDE5F0] dark:border-white/10">
        ...
        <div className="relative mx-auto grid max-w-[1280px] gap-10 px-6 py-14 md:py-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-14 lg:px-10 lg:py-20">
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#3A86FF]/20 bg-white/70 px-4 py-2 text-sm font-semibold text-[#246FDD] shadow-sm backdrop-blur dark:border-[#00F5D4]/20 dark:bg-white/5 dark:text-[#00F5D4]">
              <Sparkles size={16} />
          ...
          <div className="relative">
            ...
            <div className="relative rounded-[1.75rem] border border-white/70 bg-white p-6 shadow-[0_28px_80px_rgba(11,19,43,0.14)] dark:border-white/10 dark:bg-[#111D37] md:p-8">
              <div className="mb-6">
      ...
      <section className="mx-auto max-w-[1280px] px-6 py-14 md:py-16 lg:px-10 lg:py-20">
      ...
      <section className="border-t border-[#DDE5F0] bg-white/60 dark:border-white/10 dark:bg-white/[0.025]">
        <div className="mx-auto grid max-w-[1080px] gap-8 px-6 py-14 md:py-16 lg:grid-cols-[0.75fr_1.25fr] lg:gap-14 lg:px-10 lg:py-20">
          <div>
